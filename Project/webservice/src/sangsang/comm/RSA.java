...
public class RSA {
   ...
   public static RSA getEncKey() {
      ...
      PublicKey publicKey = keyPair.getPublic(); //怨듦컻��
      PrivateKey privateKey = keyPair.getPrivate(); //媛쒖씤��
   ...
   public static boolean dec(PrivateKey privateKey, String encString) throws Exception{
      ...
      if (privateKey == null) {
            throw new RuntimeException("오류야 오류.");
        }
      try {
   ...
   public static String decryptRsa(PrivateKey privateKey, String securedValue) throws Exception {
        ...
        String decryptedValue = new String(decryptedBytes, "utf-8"); // 臾몄옄 �몄퐫�� 二쇱쓽.
